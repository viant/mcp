...
type Store interface {
	LookupClientConfig(issuer string) (*client.Config, bool)
	AddClientConfig(issuer string, client *client.Config) error
...
func WithClient(client *client.Config) MemoryStoreOption {
...
func (m *memoryStore) LookupClientConfig(iss string) (*client.Config, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
	if m.clients != nil {
...
func (m *memoryStore) AddClientConfig(issuer string, client *client.Config) error {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.clients[issuer] = client
	return nil
